...
export default function Industrials() {
    ...
    const industrialList = listOfStocks.filter((element) => { return element.Sector === 'Industrials' });
    const ilSymbols = industrialList.map(element => element.Symbol);
