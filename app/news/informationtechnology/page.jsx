...
export default function InformationTechnology() {
    ...
    const informationtechnologylist = listOfStocks.filter((element) => { return element.Sector === 'Information Technology' });
    const ilSymbols = informationtechnologylist.map(element => element.Symbol);
        ...
        return (
            <div>
                <section className="sec">
                    <h3 id> Information Technology </h3>
                    {data.map(stock =>
