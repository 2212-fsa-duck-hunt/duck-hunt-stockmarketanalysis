...
export default function ConsumerStaples() {
    const [data, setData] = useState(null);
    const [isLoading, setIsLoading] = useState(false);
    const staplesList = listOfStocks.filter((element) => { return element.Sector === 'Consumer Staples' });
    const ilSymbols = staplesList.map(element => element.Symbol);
